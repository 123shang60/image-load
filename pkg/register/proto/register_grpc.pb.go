...
type RegisterClient interface {
	RegistNode(ctx context.Context, in *NodeInfo, opts ...grpc.CallOption) (*RegistResp, error)
}
...
func (c *registerClient) RegistNode(ctx context.Context, in *NodeInfo, opts ...grpc.CallOption) (*RegistResp, error) {
	out := new(RegistResp)
	err := c.cc.Invoke(ctx, "/register.Register/RegistNode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RegisterServer interface {
	RegistNode(context.Context, *NodeInfo) (*RegistResp, error)
...
func (UnimplementedRegisterServer) RegistNode(context.Context, *NodeInfo) (*RegistResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegistNode not implemented")
}
...
func _Register_RegistNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NodeInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RegisterServer).RegistNode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/register.Register/RegistNode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegisterServer).RegistNode(ctx, req.(*NodeInfo))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Register_RegistNode_Handler,
		},
	},
